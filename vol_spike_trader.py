...
Usage:
    ...
    python3 vol_spike_trader.py --debug  # DEBUG mode — no real orders
    python3 vol_spike_trader.py --symbol BTCUSDT
"""
...
start_logging("vol_spike_trader")
...
TRADE_CSV = os.path.join("log", "vol_spike_trades.csv")
...
def _process_symbol(client: BitunixClient, sym: str, s: dict,
    ...
    for c1 in new:
        ...
        if vol_avg == 0 or vol_now < vol_avg * SPIKE_MULT:
            continue
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Volume spike reversion perpetual futures trader")
